...
protected:
     ...
     */
    std::unique_ptr<Col<rt_float>> ascendingWaves;

    //----------------------------------------------------------------------
    /**
     Pointer to a vector of descending waves from the root.
     */
    std::unique_ptr<Col<rt_float>> descendingWaves;
...
public:
    ...
    /**
     ...
     @param fs                  samplerate to use for adaptation of reactive
                                elements.
     */
    void setSamplerate( rt_float fs );

    //----------------------------------------------------------------------
    /**
     Function to get the sample rate.

     @returns                   a rt_float with the tree's sample rate
     */
    rt_float getSamplerate( );
     ...
     */
    virtual void setInputValue( rt_float signalIn ) = 0;
    ...
    /**
     ...
     @returns                   a rt_float type output value
     */
    virtual rt_float getOutputValue( ) = 0;
...
public:
    ...
    /**
     ...
     @param Rp                  is a vector of port resistances of all
                                subtrees of the root.
     */
    virtual void setPortResistances( rt_float * Rp );
    ...
    /**
     ...
     @param *descendingWaves    is a pointer to a vector to store the resulting
                                ...
                                the subtrees
     */
    virtual void processAscendingWaves( Col<rt_float>* ascendingWaves,
                                        Col<rt_float>* descendingWaves ) = 0;
...
public:
    ...
    /**
     ...
     subtrees of the root.
     */
    void setPortResistances(rt_float * Rp);
...
public:
    ...
    /**
     ...
     @returns                   a rt_float type up-facing port resistance of that
                                WDF element
     */
    rt_float adaptPorts( rt_float sampleRate );
    ...
    /**
     ...
     @returns                   a rt_float type port resistance of that element
                                in Ohms
     */
    virtual rt_float calculateUpRes( rt_float sampleRate ) = 0;
    ...
    /**
     ...
     @returns                   the upward traveling wave of a node
     */
    virtual rt_float calculateUpB( ) = 0;
     ...
     */
    virtual void pushWaveDown( rt_float descendingWave );
     ...
     */
    virtual void calculateDownB( rt_float descendingWave ) = 0;
...
public:
    ...
    /**
     ...
     @param  descendingWave     incoming wave component on the upfacing port
     */
    virtual void calculateDownB( rt_float descendingWave );
...
public:
    ...
    /**
     ...
     @returns                   a rt_float type port resistance of that element
                                in Ohms
     */
    virtual rt_float calculateUpRes( rt_float sampleRate );
...
public:
    ...
    /**
     ...
     @param Rser                physical resistance of the series resistor in
                                Ohms
     */
    wdfTerminatedResVSource( rt_float Vs,
                             rt_float RSer );
...
public:
    ...
    /**
     ...
     @param Rpar                physical resistance of the parallel resistor in
                                Ohms
     */
    wdfTerminatedResCSource( rt_float Is,
                             rt_float RPar );
...
public:
     ...
     */
    virtual void setPortResistance( rt_float Rp );
     ...
     */
    virtual void calculateDownB( Col<rt_float>* ascendingWaves,
                                 Col<rt_float>* descendingWaves,
                                 size_t* portIndex ) = 0;
