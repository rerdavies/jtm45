...
/** tolerance for ||F||_2 */
#define TOL     1.0e-03                     // TODO: evaluate physically meaningful tolerance.
...
public:
    ...
    */
    virtual void nlSolve( Col<rt_float>* inWaves,
                          Col<rt_float>* outWaves ) = 0;
...
public:
    ...
    */
    ...
    /**
     ...
     @param outWaves            is a pointer to a vector of outgoing waves
    */
    void nlSolve( Col<rt_float>* inWaves,
    ...
    */
    void evalNlModels(Col<rt_float>* inWaves, matData* myMatData, Col<rt_float>* x);
